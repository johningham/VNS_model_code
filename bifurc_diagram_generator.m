...
% automated generation of composite plots for two-dimensional sweeps of the
...
% This produces a single combination of parameter values, and hence a
% single composite diagram, using the default values for the paper. Parts
% such a diagram were used to form the majority of Fig.2
